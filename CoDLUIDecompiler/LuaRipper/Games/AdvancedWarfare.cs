...
namespace CoDLUIDecompiler.LuaRipper
{
    class AdvancedWarfare
    {
        ...
        {
            // Found the game
            Console.WriteLine("Found supported game: Call of Duty: Advanced Warfare");
            ...
            if (reader.ReadNullTerminatedString(reader.ReadInt64(reader.ReadInt64(assetPoolsAddress + 0x38) + 8)) == "fx")
            {
                ...
                Directory.CreateDirectory("s1_luafiles");
                ...
                for (int i = 0; i < poolSize; i++)
                {
                    ...
                    string exportName = Path.Combine("s1_luafiles", reader.ReadNullTerminatedString(data.NamePtr));
